	...
	return (
		...
		>
			<Container className={classes.inner} fluid>
				...
				{opened && (
					<div className='absolute top-[70px] right-2 bg-gray-200 w-[370px] rounded-md'>
						<Group spacing={5} className={`${classes.links} flex justify-center items-center`}>
						<li	className={`${classes.link} text-black  text-xl text-center cursor-pointer bg-gray-100 w-[360px] m-1 mt-2 rounded-md`}>
					<ScrollLink offset={-150} to="about" smooth={true} duration={1000}>

						About
							</ScrollLink>
						</li>
						<li	className={`${classes.link} text-black  text-xl text-center cursor-pointer bg-gray-100 w-[360px] m-1 rounded-md`}>
					<ScrollLink offset={-150} to="products" smooth={true} duration={1000}>

						Products
							</ScrollLink>
						</li>
						<li	className={`${classes.link} text-black  text-xl text-center cursor-pointer bg-gray-100 w-[360px] m-1 rounded-md mb-2`}>
					<ScrollLink offset={-150} to="contact" smooth={true} duration={1000}>
