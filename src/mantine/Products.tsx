import { createStyles, Text, Card, SimpleGrid, rem, List, Image } from "@mantine/core"
	...
	const features = mockdata.map((feature) => (
		...
		>
			...
			<Text
				fz='lg'
				fw={500}
				className={`${classes.cardTitle} text-center flex justify-center items-center flex-col`}
				mt='md'
			>
				{feature.title}
			</Text>
