export const aboutContent = {
	title: 'About Us At ARC Global Chain,',
	paragraphs: [
		'we are passionate about providing the finest selection of premium-grade sugar products and top-quality sunflower oil. As a trusted supplier, we offer a range of unique product differentiations and business features to meet your specific needs.',
