			...
			{isScreenMd ? (
				<>
					<div className="flex flex-1 flex-col items-center justify-center space-y-5 bg-gray-100  ">
						<h4 className="  w-[800px] text-left text-4xl font-normal mb-12 leading-9 text-gray-700 mt-6">
							Sugar
						</h4>

						<ul className="  flex flex-col justify-end gap-y-2 list-disc">
							<li className="ml-60 w-[800px] text-left text-3xl   leading-7 ">
						...
						<div className="flex  w-[800px] items-center">
							<button className="h-12 mt-6 mb-5 w-36 rounded-md border-2 border-orange-500 bg-orange-500 text-sm font-semibold text-white">
								Speficitions
							</button>
						</div>
					</div>
